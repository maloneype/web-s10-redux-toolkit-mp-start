...
import { createNewQuote } from "../state/quotesSlice";
...
export default function TodoForm() {
  ...
  const dispatchQuotes=useDispatch()
  ...
  const onNewQuote = (evt) => {
    ...
    dispatchQuotes(createNewQuote({quoteText: state.quoteText, authorName: state.authorName}))
    resetForm();
  };
